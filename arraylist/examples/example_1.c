...
int main(void) {
    ...
    struct arraylist_ints int_vec = arraylist_ints_init(&gpa);
    ...
    // struct arraylist_ints int_vec = arraylist_ints_init_with_capacity(NULL, 10);
    ...
    *slot = 30;
    ...
    struct arraylist_ints other = arraylist_ints_init(&gpa);
